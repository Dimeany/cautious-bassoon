...
setup_service(int sock_fd) {
    ...
    // The service is a subclass of the "base" class which just has a virtual method
    // to generate different health data
    auto service = std::make_unique<SmallsatDetectorService>(sock_fd);
